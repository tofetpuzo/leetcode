...
CREATE TABLE Doctor (
    ...
    user_doctor VARCHAR(255) UNIQUE NOT NULL,
...
CREATE TABLE Patient (
    ...
    user_patient VARCHAR(255) UNIQUE NOT NULL,
    service_type VARCHAR(255) NOT NULL,
    test_type VARCHAR(255) NOT NULL,
    pass_word VARCHAR(255) NOT NULL,
    created_at TIMESTAMP DEFAULT NOW()
...
CREATE TABLE Laboratory (
    lab_service_id INT AUTO_INCREMENT PRIMARY KEY,
    lab_service_test_type VARCHAR(255) NOT NULL,
    service_price DOUBLE NOT NULL
);

CREATE TABLE PatientLaboratoryServices (
    lab_service_id INT,
    patient_id INT NOT NULL,
    FOREIGN KEY(lab_service_id) REFERENCES Laboratory(lab_service_id),
    FOREIGN KEY(patient_id) REFERENCES Patient(patient_id)
);
